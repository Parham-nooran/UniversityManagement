...
@NoArgsConstructor
public class DeleteStudentController extends StudentController implements Initializable {

    //----------------------------------------------------------------Constructor
    public DeleteStudentController(Scene scene) {
        super("DeleteStudent", scene);
    }
    //----------------------------------------------------------------
    ...
    public void  deleteStudent(){
        new Thread(() -> StudentManagementController.studentRepository.deleteById(student.getId())).start();
        StudentManagementController.students.remove(student);
    ...
    private void persianTranslate(ArrayList<String> fxmlID, ArrayList<String> text){
        ...
        yes.setText(text.get(21));
        no.setText(text.get(22));
